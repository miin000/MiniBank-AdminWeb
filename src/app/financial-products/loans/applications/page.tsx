...
// Gọi BE theo từng status rồi merge lại
        ...
        >
            ...
            <section className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
                ...
                <div className="flex flex-wrap items-center gap-4 border-b border-zinc-200 p-5">
                    ...
                    <button
                        className="flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-200 hover:bg-zinc-50"
                    >
                        <Filter
                            size={18}
                    ...
                    <table className="w-full min-w-[1100px]">
                        ...
                        <thead className="border-b border-zinc-200 bg-zinc-50">
                            ...
                            <tr>
                                ...
                                <th className="px-5 py-4 text-left text-sm font-semibold text-zinc-600">
                                    Mã hồ sơ
                                </th>
                                ...
                                <th className="px-5 py-4 text-center text-sm font-semibold text-zinc-600">
                                    Thao tác
                                </th>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="px-5 py-5">
                                                    ...
                                                    <span
                                                        className={`inline-flex rounded-full px-4 py-2 text-sm font-medium ${status.className}`}
                                                    >
                                                        {
                                                            status.label
                                                        }
